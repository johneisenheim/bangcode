function TrainingMissed(win){
	...
	var infos = Titanium.UI.createLabel({
		...
		text : 'Cerca di tenere il tuo dispositivo il più dritto possibile quando compi il movimento dello sparo.',
		textAlign : 'center',
		color : '#aa938b',
		width : '85%'
	});
