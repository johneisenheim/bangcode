...
//Rare exceptions to indicate a bug in the _bangwesternduels code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BangWesternDuels proxies.
 */
