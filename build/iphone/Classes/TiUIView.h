...
/**
 Base class for all BangWesternDuels views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BangWesternDuels view hierarchy (such as wrapped iOS UIViews) was touched.
